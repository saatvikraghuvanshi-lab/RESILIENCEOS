...
const LandingPage: React.FC<LandingPageProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#050505] text-white flex flex-col items-center justify-center p-4 overflow-hidden relative" role="main">
      ...
      <div className="w-full max-w-sm relative z-10">
        <header className="text-center mb-6 animate-in fade-in slide-in-from-top-4 duration-700">
          <div className="flex justify-center mb-4">
            <ShieldLogo className="w-14 h-14 drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]" />
          </div>
          <h1 className="text-3xl font-black tracking-tight uppercase leading-none mb-2">
            Resilience<span className="text-blue-500">OS</span>
          </h1>
          <p className="text-[9px] text-zinc-400 font-mono uppercase tracking-[0.4em] font-bold">National Disaster Command Unit</p>
        </header>

        <div className="bg-zinc-900/40 border border-white/5 rounded-[32px] p-6 backdrop-blur-3xl shadow-2xl animate-in zoom-in-95 duration-500">
          <div className="flex border-b border-white/5 mb-6" role="tablist">
            <button
              id="tab-login"
              role="tab"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <label className="text-[8px] font-bold uppercase text-zinc-500 tracking-widest font-mono ml-1">Terminal ID</label>
              <input
                required
                type="email"
                value={email}
                ...
                className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none placeholder:text-zinc-700 shadow-inner"
              />
            </div>

            <div className="space-y-2">
              <label className="text-[8px] font-bold uppercase text-zinc-500 tracking-widest font-mono ml-1">Secure Key</label>
              <input
                required
                type="password"
                value={password}
            ...
            <button
              type="submit"
              className="w-full py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-2xl font-black uppercase text-[10px] tracking-[0.2em] transition-all active:scale-[0.98] shadow-lg shadow-blue-600/20 group overflow-hidden relative"
            >
          ...
          <div className="mt-6 flex flex-col items-center gap-4">
            ...
            <p className="text-[7px] text-zinc-600 uppercase font-mono text-center tracking-widest leading-relaxed">
              Resilience-OS v4.2.0-Tactical<br />
              Authorized Field Uplink Terminal
            </p>
          </div>
        </div>
      </div>
